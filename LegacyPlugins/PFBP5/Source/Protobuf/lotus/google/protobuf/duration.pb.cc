...
class DurationDefaultTypeInternal {
 public:
  ::lotus::google::protobuf::internal::ExplicitlyConstructed<Duration>
      _instance;
...
void InitDefaultsDurationImpl() {
  ...
  {
    void* ptr = &::lotus::google::protobuf::_Duration_default_instance_;
    new (ptr) ::lotus::google::protobuf::Duration();
    ::lotus::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::lotus::google::protobuf::Duration::InitAsDefaultInstance();
}

void InitDefaultsDuration() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::lotus::google::protobuf::GoogleOnceInit(&once, &InitDefaultsDurationImpl);
}
...
const ::lotus::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::lotus::google::protobuf::Duration, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::lotus::google::protobuf::Duration, seconds_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::lotus::google::protobuf::Duration, nanos_),
};
static const ::lotus::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::lotus::google::protobuf::Duration)},
};

static ::lotus::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::lotus::google::protobuf::Message*>(&::lotus::google::protobuf::_Duration_default_instance_),
};
...
Duration::Duration(::lotus::google::protobuf::Arena* arena)
...
void Duration::RegisterArenaDtor(::lotus::google::protobuf::Arena* arena) {
}
...
const ::lotus::google::protobuf::Descriptor* Duration::descriptor() {
...
Duration* Duration::New(::lotus::google::protobuf::Arena* arena) const {
  return ::lotus::google::protobuf::Arena::CreateMessage<Duration>(arena);
}
...
::lotus::google::protobuf::uint8* Duration::InternalSerializeWithCachedSizesToArray(
...
void Duration::MergeFrom(const ::lotus::google::protobuf::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:google.protobuf.Duration)
  GOOGLE_DCHECK_NE(&from, this);
  const Duration* source =
      ::lotus::google::protobuf::internal::DynamicCastToGenerated<const Duration>(
          &from);
  if (source == NULL) {
...
void Duration::CopyFrom(const ::lotus::google::protobuf::Message& from) {
...
::lotus::google::protobuf::Metadata Duration::GetMetadata() const {
  protobuf_google_2fprotobuf_2fduration_2eproto::protobuf_AssignDescriptorsOnce();
