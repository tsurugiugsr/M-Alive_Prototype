...
public class libprotobuf : ModuleRules
{
	public libprotobuf(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		{
			is_supported = true;
			List<String> Architectures = new List<String> { "arm64-v8a" };
			foreach(var arch in Architectures) {
                PublicAdditionalLibraries.Add("/Users/tsurugiugushiro/Programs/M-Memorizable/Assistant/Plugins/PFBP5/Source/ThirdParty/libprotobuf/lib/android/arm64-v8a/Release/libprotobuf.a");
			}
		}
