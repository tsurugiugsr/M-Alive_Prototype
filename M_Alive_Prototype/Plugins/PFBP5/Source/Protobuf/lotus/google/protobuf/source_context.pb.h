...
class PROTOBUF_API SourceContext : public ::lotus::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.protobuf.SourceContext) */ {
 public:
  SourceContext();
  ...
  SourceContext* New(::lotus::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  ::lotus::google::protobuf::internal::ArenaStringPtr file_name_;
...
inline void SourceContext::set_file_name(const ::std::string& value) {
  ...
  file_name_.SetNoArena(&::lotus::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
...
inline void SourceContext::set_file_name(const char* value) {
  ...
  file_name_.SetNoArena(&::lotus::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void SourceContext::set_file_name(const char* value, size_t size) {
  ...
  file_name_.SetNoArena(&::lotus::google::protobuf::internal::GetEmptyStringAlreadyInited(),
...
inline ::std::string* SourceContext::mutable_file_name() {
  ...
  return file_name_.MutableNoArena(&::lotus::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* SourceContext::release_file_name() {
  // @@protoc_insertion_point(field_release:google.protobuf.SourceContext.file_name)
  
  return file_name_.ReleaseNoArena(&::lotus::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void SourceContext::set_allocated_file_name(::std::string* file_name) {
  ...
  file_name_.SetAllocatedNoArena(&::lotus::google::protobuf::internal::GetEmptyStringAlreadyInited(), file_name);
